package io.shadowrealm.content.bosses.wintertodt;
...
import io.shadowrealm.model.collisionmap.TileControl;
...
//            PlayerHandler.executeGlobalMessage("[@blu@Wintertodt@bla@] A new game has just started!");
    ...
    private static void award(Player player) {
        ...
        player.getPA().addSkillXP(player.playerLevel[Skill.FIREMAKING.getId()] * 100, 11, true);
