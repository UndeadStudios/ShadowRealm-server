package io.shadowrealm.content.questing.LearningTheRopes;
...
import io.shadowrealm.content.questing.Quest;
...
public class LearningTheRopesQuest extends Quest {
    ...
    public List<String> getJournalText(int stage) {
        ...
        switch (stage) {
            case 0:
                lines.add("To start this quest talk to the shadow realm Guide");
                                            ...
                                            player.start(getexiliusGuide()
                                                    ...
                                                    .option(new DialogueOption("Sure, I can start now!", e -> {
                                                                ...
                                                                e.start(getexiliusGuide()
                                                                        ...
                                                                        .npc("The information these display", "will help you during your time in shadow realm.")
    ...
    private DialogueBuilder getexiliusGuide() {
