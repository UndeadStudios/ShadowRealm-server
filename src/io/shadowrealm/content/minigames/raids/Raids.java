...
//        if (player.getPerkSytem().gameItems.stream().anyMatch(item -> item.getId() == 33109) && Misc.random(0,1000) > 985) {
//            rareChance -= 5;
//        }
//
//        int amt = player.getPerkSytem().gameItems.stream().anyMatch(item -> item.getId() == 33109) && Misc.random(0,100) <= 10 ? 6 : 3;
