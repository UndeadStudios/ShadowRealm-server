package io.shadowrealm.content.combat.melee;
...
public class MeleeData {
    ...
    public static boolean usingHolyScythe(Player player) {
        return player.attacking.getCombatType() == CombatType.MELEE && player.getItems().isWearingItem(29047);
    }
    public static boolean usingSangScythe(Player player) {
        return player.attacking.getCombatType() == CombatType.MELEE && player.getItems().isWearingItem(29047);
    }
    ...
    public static int getWepAnim(Player c) {
		...
		if (weaponName.contains("Holy Scythe of Vitur")) {
			switch (c.getCombatConfigs().getWeaponMode().getAttackStyle()) {
				case ACCURATE:
				case AGGRESSIVE:
				case CONTROLLED:
		...
		if (weaponName.contains("scythe of vitur")) {
			...
			if (weaponName.contains("Sanguine scythe of vitur")) {
				switch (c.getCombatConfigs().getWeaponMode().getAttackStyle()) {
					case ACCURATE:
					case AGGRESSIVE:
					case CONTROLLED:
