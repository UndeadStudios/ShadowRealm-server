package io.shadowrealm.content.combat.range;

import io.shadowrealm.content.achievement_diary.DifficultyAchievementDiary;
import io.shadowrealm.content.combat.effects.damageeffect.DamageBoostingEffect;
import io.shadowrealm.content.combat.effects.damageeffect.impl.bolts.*;
import io.shadowrealm.content.combat.weapon.RangedWeaponType;
...
public class RangeData {
	...
	public static final int[] MULTI_WEAPONS = {
		...
		public static final int[] BOWS = { 19481, 19478, 12788, 9185, 11785, 26374, 25916/*dhcb T*/, 21012/*dhcb*/, 839, 845, 847, 851, 855, 859, 841, 843, 849,
				...
				4221, 4222, 4223, 4734, 6724, 20997, 8029, 21902, 22550, 25865, 29041, 29042, 29043, 29044, 29045 };
    ...
    public static final int[] NO_ARROW_DROP = { 11959, 10033, 10034, 4212, 22550, 25865, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221,
	...
	private static final List<DamageBoostingEffect> BOLT_EFFECTS = Collections
			.unmodifiableList(Arrays.asList(new DragonBoltSpecial(), new OpalBoltSpecial(), new JadeBoltSpecial(), new PearlBoltSpecial(), new TopazBoltSpecial(),
					new EmeraldBoltSpecial(), new RubydragonBoltSpecial(), new SapphireBoltSpecial(), new RubyBoltSpecial(), new DiamondBoltSpecial(), new OnyxBoltSpecial()));
...
//				
				...
				// CRYSTAL_BOW
				{ 4212, 250 }, { 4214, 250 },  { 22550, 250},  { 25865, 350},{ 4215, 250 }, { 4216, 250 }, { 4217, 250 }, { 4218, 250 }, { 4219, 250 }, { 4220, 250 }, { 4221, 250 }, { 4222, 250 },
				{ 4223, 250 }, {25865, 250},
	...
	public static int getRangeProjectileGFX(Player c) {
		...
		int[][] data = {
				...
				// OTHERS
				{ 6522, 442 }, { 4740, 27 }, { 4212, 249 } ,{ 4214, 249 },  { 25865, 349},  { 22550, 249},{ 4215, 249 }, { 4216, 249 }, { 4217, 249 }, { 4218, 249 }, { 4219, 249 }, { 4220, 249 }, { 4221, 249 },
