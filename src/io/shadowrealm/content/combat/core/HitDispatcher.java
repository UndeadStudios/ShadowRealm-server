...
import io.shadowrealm.content.combat.effects.damageeffect.impl.ToxicBlowpipeEffect;
import io.shadowrealm.content.combat.effects.damageeffect.impl.ToxicStaffOfTheDeadEffect;
import io.shadowrealm.content.combat.effects.damageeffect.impl.amuletofthedamned.impl.GuthanEffect;
...
public abstract class HitDispatcher {
    ...
    private void dropArrow(int arrowId) { // TODO delete arrows from player
        ...
        if (attacker.playerEquipment[Player.playerCape] == 10499 || attacker.getItems().isWearingItem(22109,
                Player.playerCape)
                || attacker.getItems().isWearingItem(33037, Player.playerCape) || attacker.getItems().isWearingItem(28347, Player.playerCape) || attacker.getItems().isWearingItem(19480, Player.playerCape)
