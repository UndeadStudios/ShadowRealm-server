...
import io.shadowrealm.content.bosses.hydra.HydraStage;
...
import io.shadowrealm.model.entity.npc.NPCClipping;
...
import static io.shadowrealm.content.combat.Hitmark.HIT;
...
//        }
    ...
    private boolean determineWeaponStyle() {
        ...
        if (!attacker.usingMagic) {
            ...
            attacker.usingCross =
                    attacker.playerEquipment[Player.playerWeapon] == 4734 || attacker.playerEquipment[Player.playerWeapon] == 9185 || attacker.playerEquipment[Player.playerWeapon] == 11785 || attacker.playerEquipment[Player.playerWeapon] == 21012 || attacker.playerEquipment[Player.playerWeapon] == 25916 || attacker.playerEquipment[Player.playerWeapon] == 26374|| attacker.playerEquipment[Player.playerWeapon] == 21902;
    ...
    public static int getRangeDistance(Player player) {
        ...
        if (name.equals("Godly twisted bow"))
            ...
            return isLongRange ? 9 : 7;
        else if (name.contains("dragon hunter crossbow (t)"))
            return isLongRange ? 9 : 7;
