...
public class WeaponDataConstants {
    ...
    public static final int[] CRUSH_SWORDS = {
        ...
        Items.SARADOMIN_SWORD, Items.SARADOMINS_BLESSED_SWORD, Items.SHADOW_SWORD, Items.SPATULA, Items.GILDED_2H_SWORD, 26233,
    };
    ...
    public static final int[] SCYTHE = {
            Items.SCYTHE, Items.SCYTHE_OF_VITUR,Items.SCYTHE_OF_OSIRIS, 29499, 29047,
    };
    ...
    public static final int[] MACES = {
        ...
        Items.ANGER_MACE, Items.ANCIENT_MACE, Items.ROLLING_PIN, Items.TZHAAR_KET_EM,Items.OSIRIS_CHAINMACE,
    ...
    public static final int[] WHIPS = {
            ...
            Items.ABYSSAL_WHIP, Items.FROZEN_ABYSSAL_WHIP, Items.VOLCANIC_ABYSSAL_WHIP, Items.ABYSSAL_TENTACLE, 28213, 28214, 28215, 28216, 28217, 28218, 28219, 28220, 26482, 26484
   ...
   public static final int[] STANDARD_STAFFS = {
           ...
           Items.MUD_BATTLESTAFF, Items.MYSTIC_LAVA_STAFF, Items.LAVA_BATTLESTAFF, Items.STEAM_BATTLESTAFF, Items.DUST_BATTLESTAFF,
    ...
    public static final int[] CROSSBOWS = {
            Items.CROSSBOW, Items.BRONZE_CROSSBOW, Items.IRON_CROSSBOW, Items.STEEL_CROSSBOW,  Items.MITH_CROSSBOW, Items.ADAMANT_CROSSBOW,
            Items.RUNE_CROSSBOW, Items.DRAGON_CROSSBOW, Items.DRAGON_HUNTER_CROSSBOW_T, Items.ARMADYL_CROSSBOW,  Items.KARILS_CROSSBOW,
    ...
    public static final int[] BOWS = {
            ...
            //Special Bows
            Items.CURSED_GOBLIN_BOW, Items.TRAINING_BOW, Items.OGRE_BOW, Items.DARK_BOW, Items.CRYSTAL_BOW, Items.TWISTED_BOW, 8029, Items.CRAWS_BOW,
