...
public enum FarmingPatches {
	...
	HOME_HERB(new Position(3074, 3462), new Position(3077, 3465), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.HERB),
	HOME_FLOWER(new Position(3078, 3462), new Position(3081, 3465), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.FLOWER),
	HOME_ALLOTMENT_NORTH( new Position(3074, 3457), new Position(3085, 3462), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.ALLOTMENT),
	HOME_ALLOTMENT_SOUTH(new Position(3074, 3466), new Position(3085, 3469), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.ALLOTMENT),
