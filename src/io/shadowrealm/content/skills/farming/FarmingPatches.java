...
public enum FarmingPatches {
	...
	LUMBRIDGE_TREE(new Position(3191, 3229, 0), new Position(3195, 3233, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.FRUIT_TREE),
	VARROCK_TREE(new Position(3227, 3457, 0), new Position(3231, 3461, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.FRUIT_TREE),
	FALADOR_TREE(new Position(3002, 3371, 0), new Position(3006, 3375, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.FRUIT_TREE),
	TAVERLY_TREE(new Position(2934, 3436, 0), new Position(2938, 3440, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.FRUIT_TREE),
	STRONGHOLD_TREE(new Position(2434, 3413, 0), new Position(2438, 3417, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.FRUIT_TREE),
