package io.shadowrealm.content.skills.agility;
...
import io.shadowrealm.content.skills.agility.impl.BarbarianAgility;
import io.shadowrealm.content.skills.agility.impl.GnomeAgility;
import io.shadowrealm.content.skills.agility.impl.Lighthouse;
import io.shadowrealm.content.skills.agility.impl.Shortcuts;
import io.shadowrealm.content.skills.agility.impl.WildernessAgility;
...
import io.shadowrealm.model.entity.player.PlayerMovementStateBuilder;
...
public class AgilityHandler {
    ...
    public double getXp(int objectId) {
        switch (objectId) {
           ...
           // case BarbarianAgility.BARBARIAN_LADDER2_OBJECT:
