...
public enum StallData {
    ...
    Gold(new HashMap<Rarity, List<GameItem>>() {
        {
            put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, Misc.random(100, 1_500))));
        }
    }, 1, 10, 40, 40000, 634),
    Gold2(new HashMap<Rarity, List<GameItem>>() {
        {
            put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, Misc.random(1000, 5_000))));
        }
    }, 5, 16, 40, 40000, 634),
    Gold3(new HashMap<Rarity, List<GameItem>>() {
        {
            put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, Misc.random(1_000, 5_000))));
        }
    }, 10, 20, 40, 40000, 634),
    ...
    Gold9(new HashMap<Rarity, List<GameItem>>() {
        {
            put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, Misc.random(1_000, 20_000))));
        }
    }, 70, 60, 40, 40000, 634),
    Gold10(new HashMap<Rarity, List<GameItem>>() {
        {
            put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, Misc.random(1000, 50_000))));
        }
    }, 80, 60, 40, 40000, 634),
    Gold11(new HashMap<Rarity, List<GameItem>>() {
        {
            put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, Misc.random(1_000, 70_000))));
        }
    }, 90, 60, 40, 40000, 634),
    Gold12(new HashMap<Rarity, List<GameItem>>() {
        {
            put(Rarity.ALWAYS, Arrays.asList(new GameItem(995, Misc.random(20_000, 45_000))));
        }
    }, 99, 60, 40, 40000, 634);
    /**
