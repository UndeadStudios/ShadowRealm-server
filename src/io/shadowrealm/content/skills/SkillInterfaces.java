...
import io.shadowrealm.content.skills.herblore.PotionData.FinishedPotions;
...
public class SkillInterfaces {
	...
	public void agilityComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("30", "Rocks in the Corsair Cove Resource Area", 6517, 10);
			menuLine("31", "Catherby Cliff", 6515, 11);
			menuLine("32", "Ardougne Log Balance Shortcut", 6517, 12);
			menuLine("33", "Water Obelisk Island Escape", 6516, 13);
			menuLine("36", "Gnome Stronghold Shortcut", 6517, 14);
			menuLine("37", "Al Kharid Mining Pit Sliffside Scramble", 6517, 15);
			menuLine("39", "Yanille Wall", 6517, 16);
			menuLine("40", "Trollheim Easy Cliffside Scramble", 6517, 17);
			menuLine("41", "Dwarven Mine Narrow Crevice", 6517, 18);
			menuLine("42", "Trollheim Medium Cliffside Scramble", 6516, 19);
			menuLine("43", "Trollheim Advanced Cliffside Scramble", 6517, 20);
			menuLine("44", "Cosmic Temple Medium Narrow Walkway", 6517, 21);
			menuLine("46", "Trollheim Hard Cliffside Scramble", 6516, 22);
			menuLine("47", "Log Balance To The Fremennik Province", 6517, 23);
			menuLine("48", "Edgeville Dungeon To Varrock Sewers Pipe", 6515, 24);
			menuLine("51", "Karamja Crossing, South Of The Volcano", 6516, 25);
			menuLine("53", "Port Phasmatys Ectopool Shortcut", 6517, 26);
			menuLine("58", "Elven Overpass Easy Cliffside Scramble", 6517, 27);
			menuLine("59", "Slayer Tower Medium Spiked Chain Climb", 6517, 28);
			menuLine("61", "Slayer Dungon Narrow Crevice", 6517, 29);
			menuLine("62", "Trollheim Wilderness Route", 6516, 30);
			menuLine("64", "Paterdomus Temple To Morytania Shortcut", 6517, 31);
			menuLine("66", "Cosmic Temple Advanced Narrow Walkway", 6517, 32);
			menuLine("68", "Elven Overpass Medium Cliffside Scramble", 6517, 33);
			menuLine("70", "Taverly Dungeon Pipe Squeeze", 6516, 34);
			menuLine("71", "Slayer Tower Advanced Spiked Chain Climb", 6517, 35);
			menuLine("74", "Shilo Village Stepping Stone", 6514, 36);
			menuLine("80", "Taverly Dungeon Spiked Blade Jump", 6514, 37);
			menuLine("81", "Slayer Dungeon Chasm Jump", 6514, 38);
			menuLine("85", "Elven Overpass Advanced Cliff Scramble", 6517, 39);
			//menuLine("86", "Kalphite Lair wall shortcut", 6516, 40);
