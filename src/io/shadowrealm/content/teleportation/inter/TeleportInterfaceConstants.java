package io.shadowrealm.content.teleportation.inter;
...
public class TeleportInterfaceConstants {
    ...
    private static final TeleportContainer MONSTERS = new TeleportContainer(Lists.newArrayList(
            ...
            new TeleportButtonStandard("All Giants", new Position(1432, 9911, 0)),
            ...
            new TeleportButtonStandard("Ogers", new Position(2528, 3376, 0)),
    ...
    private static final TeleportContainer BOSSES = new TeleportContainer(Lists.newArrayList(
            ...
            new TeleportButtonStandard("Kalphite Queen", new Position(3508, 9492, 0)),
