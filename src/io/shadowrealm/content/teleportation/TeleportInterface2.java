...
//        Grotesque_Guardians(4, 102249, true, "Teleports you to the Grotesque Guardians", new Position(3428, 3541, 2)),
        ...
        Corporeal_Beast(4, 103013, true, "Teleports you to the Corporeal Beast", new Position(2964, 4382, 2)),
        Zulrah(4, 103018, true, "Teleports you to the Zulrah", new Position(2203, 3056, 0)),
        Cerberus(4, 103023,true, "Teleports you to the Cerberus", new Position(1310, 1248, 0)),
        Abyssal_Sire(4, 103028, true, "Teleports you to the Abyssal Sire", new Position(3038, 4767, 0)),
        Vorkath(4,  103033,true, "Teleports you to the Vorkath", new Position(2272, 4050, 0)),
        Alchemical_hydra(4, 103038,true, "Teleports you to the Alchemical hydra", new Position(1354, 10259, 0)),
        The_Nightmare(4,  103043,true, "Teleports you to the The Nightmare", new Position(3808, 9755, 1)),
        Nex(4, 103048, true, "Teleports you to the Nex", new Position(2856, 5220, 0)),
