package io.shadowrealm.content.teleportation;
...
public class TeleportInterface2 {
    ...
    public enum TeleportationData {
        ...
        Slayer_masters(1, 102214, true, "Teleports you to  the Slayer Masters", new Position(3112, 3514, 0)),
        ...
        Falador(2, 102254, true, "Teleports you to Falador", new Position(2964, 3378, 0)),
        Hosidius(2, 103003, true, "Teleports you to Hosidius", new Position(1758,3604,0)),
        Karamja(2, 103008, true, "Teleports you to Karamja", new Position(2948, 3147, 0)),
        Kebos_Lowlands(2, 103013, true, "Teleports you to Kebos Lowlands", new Position(1310, 3618, 0)),
        Keldagrim(2, 103018, true, "Teleports you to Keldagrim", new Position(2889, 10224, 0)),
        Lovakengj(2, 103023, true, "Teleports you to Lovakengj", new Position(1508,3783,0)),
        Lumbridge(2, 103028, true, "Teleports you to Lumbridge", new Position(3222, 3218)),
        Miscellania(2, 103033, true, "Teleports you to Miscellania", new Position(2531, 3856, 0)),
        Neitiznot(2, 103038, true, "Teleports you to Neitiznot", new Position(2321, 3804, 0)),
        Port_Piscarilius(2, 103043, true, "Teleports you to Port Piscarilius", new Position(1809,3776,0)),
        Port_Sarim(2, 103048, true, "Teleports you to Port Sarim", new Position(3014, 3215, 0)),
        ...
        Thermonuclear_Smoke_Devil(4, 102249, true, "Teleports you to the Thermonuclear Smoke Devil", new Position(2404, 9415, 0)),
        Kraken(4, 102254, true, "Teleports you to the Kraken", new Position(2280, 10016, 0)),
        Godwars(4, 103003, true, "Teleports you to the Godwars.", new Position(2948, 3147, 0)),
        Corporeal_Beast(4, 103008, true, "Teleports you to the Corporeal Beast", new Position(2964, 4382, 2)),
        Zulrah(4, 103013, true, "Teleports you to the Zulrah", new Position(2203, 3056, 0)),
        Cerberus(4, 103018,true, "Teleports you to the Cerberus", new Position(1310, 1248, 0)),
        Abyssal_Sire(4, 103023, true, "Teleports you to the Abyssal Sire", new Position(3038, 4767, 0)),
        Vorkath(4,  103028,true, "Teleports you to the Vorkath", new Position(2272, 4050, 0)),
        Alchemical_hydra(4, 103033,true, "Teleports you to the Alchemical hydra", new Position(1354, 10259, 0)),
        The_Nightmare(4,  103038,true, "Teleports you to the The Nightmare", new Position(3808, 9755, 1)),
        Nex(4, 103043, true, "Teleports you to the Nex", new Position(2856, 5220, 0)),
