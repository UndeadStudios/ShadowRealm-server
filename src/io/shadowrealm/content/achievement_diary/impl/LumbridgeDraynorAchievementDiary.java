...
public final class LumbridgeDraynorAchievementDiary extends StatefulAchievementDiary<LumbridgeDraynorDiaryEntry> {
	...
	public final void display() {
		...
		int[] frames = { 26485, 26486, 26487, 26488, 26489, 26490, 26491, 26493, 26494, 26495, 26496, 26497, 26499, 26500, 26501,
		...
		player.getPA().sendFrame126("@dre@Lumbridge & Draynor Diary", 26659);
		...
		player.getPA().sendFrame126(hasCompleted("HARD") ? "@blu@<str=1>Hard</str>" : "@blu@Hard", 26498);
