...
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.COOK_MONK;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.CRYSTAL;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.HERB_PACK;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.SEED_PACK;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.FLETCH_OAK_SHORT_WEST;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.FULL_VOID;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.GNOME_AGILITY;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.KILL_ELVES;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.KILL_THERMO;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.KILL_ZULRAH;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.PEST_CONTROL;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.PEST_CONTROL_TELEPORT;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.PICKPOCKET_GNOME;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.SPIRIT_TREE_WEST;
import static io.shadowrealm.content.achievement_diary.impl.WesternDiaryEntry.UPGRADE_VOID;
...
public final class WesternAchievementDiary extends StatefulAchievementDiary<WesternDiaryEntry> {
	...
	public final void display() {
		...
		int[] frames = { 26485, 26486, 26487, 26488, 26489, 26491, 26492, 26493, 26494, 26496, 26497, 26498, 26499, 26501,
		...
		player.getPA().sendFrame126("@dre@Western Diary", 26659);
		...
		player.getPA().sendFrame126(hasCompleted("HARD") ? "@blu@<str=1>Hard</str>" : "@blu@Hard", 26495);
