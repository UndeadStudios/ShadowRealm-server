...
import static io.shadowrealm.content.achievement_diary.impl.VarrockDiaryEntry.*;
...
public final class VarrockAchievementDiary extends StatefulAchievementDiary<VarrockDiaryEntry> {
	...
	public final void display() {
		...
		int[] frames = { 26485, 26486, 26487, 26488, 26489, 26490, 26491, 26492, 26494, 26495, 26496, 26497, 26498, 26499, 26500,
				26502, 26503, 26504, 26505, 26507, 26508, 26509, 26510, 26511, 26512, 26513, 26514, 26515, 26516, 26517,
				26518, 26519, 26520, 26521, 26522, 26523, 26524, 26525, 26526, 26527, 26528, 26529, 26530 };

		player.getPA().resetQuestInterface();
		frameIndex = 0;
		
		player.getPA().sendFrame126("@dre@Varrock Diary", 26659);
		player.getPA().sendFrame126("", 8145);
		player.getPA().sendFrame126(hasCompleted("EASY") ? "@blu@<str=1>Easy</str>" : "@blu@Easy", 26484);
		player.getPA().sendFrame126(hasCompleted("MEDIUM") ? "@blu@<str=1>Medium</str>" : "@blu@Medium", 26493);
		player.getPA().sendFrame126(hasCompleted("HARD") ? "@blu@<str=1>Hard</str>" : "@blu@Hard", 26501);
		player.getPA().sendFrame126(hasCompleted("ELITE") ? "@blu@<str=1>Elite</str>" : "@blu@Elite", 26506);
