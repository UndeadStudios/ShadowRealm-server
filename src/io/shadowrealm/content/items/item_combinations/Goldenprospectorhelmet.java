...
public class Goldenprospectorhelmet extends ItemCombination {

	public Goldenprospectorhelmet(GameItem outcome, Optional<List<GameItem>> revertedItems, GameItem[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendItemStatement("You combined the items and created a pair of Golden prospector helmet.", outcome.getId());
