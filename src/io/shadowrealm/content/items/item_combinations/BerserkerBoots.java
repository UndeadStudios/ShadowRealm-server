...
public class BerserkerBoots extends ItemCombination {

	public BerserkerBoots(GameItem outcome, Optional<List<GameItem>> revertedItems, GameItem[] items) {
	...
	public void combine(Player player) {
		...
		player.getDH().sendItemStatement("You combined the items and created a pair of berserker boots.", outcome.getId());
