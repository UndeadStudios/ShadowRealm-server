...
import io.shadowrealm.content.achievement.inter.TasksInterface;
...
import io.shadowrealm.content.worldevent.WorldEventInformation;
import io.shadowrealm.model.Area;
import io.shadowrealm.model.SquareArea;
...
import static io.shadowrealm.model.entity.npc.drops.DropManager.getModifier;
...
public class QuestTab {
    ...
    public void updateInformationTab() {
        ...
        player.getPA().sendFrame126("@or1@- Vote count: @gre@"+Server.getVoteCounter(), lines.get(index++));
