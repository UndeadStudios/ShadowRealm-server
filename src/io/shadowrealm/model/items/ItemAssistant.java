...
public class ItemAssistant {
	...
	public void deleteArrow() {
		...
		if (player.getItems().isWearingItem(10499, player.playerCape) || player.getItems().isWearingItem(22109, player.playerCape) || player.getItems().isWearingItem(28347, player.playerCape) || player.getItems().isWearingItem(19480, player.playerCape) ||SkillcapePerks.RANGING.isWearing(player)
	...
	public void deleteEquipment() {
		...
		if ( (Arrays.stream(WeaponDataConstants.THROWN).anyMatch(id -> id == thrownweapons) || player.usingOtherRangeWeapons) && !player.getItems().isWearingItem(Items.TOXIC_BLOWPIPE)) {
			if (player.getItems().isWearingItem(10499, player.playerCape) || player.getItems().isWearingItem(28347, player.playerCape) || player.getItems().isWearingItem(19480, player.playerCape) || player.getItems().isWearingItem(22109, player.playerCape)
