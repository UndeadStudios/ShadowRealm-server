...
public enum Staff {
    ...
    EARTH(Lists.newArrayList(Items.STAFF_OF_EARTH, Items.EARTH_BATTLESTAFF, Items.MUD_BATTLESTAFF, Items.LAVA_BATTLESTAFF,Items.LAVA_BATTLESTAFF_4, Items.LAVA_BATTLESTAFF_2, Items.LAVA_BATTLESTAFF_3, Items.DUST_BATTLESTAFF,
            Items.MYSTIC_MUD_STAFF, Items.MYSTIC_LAVA_STAFF, Items.MYSTIC_DUST_STAFF),
            Lists.newArrayList(Items.EARTH_RUNE)),
    FIRE(Lists.newArrayList(Items.STAFF_OF_FIRE, Items.FIRE_BATTLESTAFF, Items.LAVA_BATTLESTAFF,Items.LAVA_BATTLESTAFF_4, Items.LAVA_BATTLESTAFF_2, Items.LAVA_BATTLESTAFF_3, Items.STEAM_BATTLESTAFF, Items.SMOKE_BATTLESTAFF,
