package io.shadowrealm.model.entity.player.mode;
...
public abstract class Mode {
	...
	public boolean isrogue() {
		return type == ModeType.ROGUE;
	}
	public boolean isroguehc() {
		return type == ModeType.ROGUE_HARDCORE_IRONMAN;
	}
	public boolean isrogueiron() {
		return type == ModeType.ROGUE_IRONMAN;
	}
