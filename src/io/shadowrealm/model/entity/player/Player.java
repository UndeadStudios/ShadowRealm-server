...
import io.shadowrealm.content.*;
import io.shadowrealm.content.achievement.AchievementHandler;
import io.shadowrealm.content.achievement.AchievementType;
import io.shadowrealm.content.achievement.Achievements;
import io.shadowrealm.content.achievement_diary.AchievementDiaryManager;
import io.shadowrealm.content.achievement_diary.RechargeItems;
...
import io.shadowrealm.content.combat.CombatItems;
import io.shadowrealm.content.combat.EntityDamageQueue;
import io.shadowrealm.content.combat.Hitmark;
import io.shadowrealm.content.combat.core.AttackEntity;
import io.shadowrealm.content.combat.death.PlayerDeath;
import io.shadowrealm.content.combat.death.kill_limiter.KillLimitHandler;
import io.shadowrealm.content.combat.effects.damageeffect.impl.amuletofthedamned.impl.ToragsEffect;
...
import io.shadowrealm.content.combat.pvp.Killstreak;
import io.shadowrealm.content.combat.stats.BossTimers;
import io.shadowrealm.content.combat.stats.NPCDeathTracker;
import io.shadowrealm.content.combat.weapon.CombatStyle;
import io.shadowrealm.content.combat.weapon.WeaponMode;
import io.shadowrealm.content.commands.all.Reclaim;
import io.shadowrealm.content.compromised.CompromisedAccounts;
import io.shadowrealm.content.dailyrewards.DailyRewards;
import io.shadowrealm.content.dailytasks.DailyTask;
...
import io.shadowrealm.content.event.eventcalendar.EventChallengeMonthlyReward;
import io.shadowrealm.content.item.lootable.impl.*;
import io.shadowrealm.content.item.lootable.unref.*;
import io.shadowrealm.content.items.Degrade;
import io.shadowrealm.content.items.PvpWeapons;
import io.shadowrealm.content.items.pouch.GemBag;
import io.shadowrealm.content.items.pouch.HerbSack;
import io.shadowrealm.content.items.pouch.RunePouch;
import io.shadowrealm.content.itemskeptondeath.perdu.PerduLostPropertyShop;
import io.shadowrealm.content.lootbag.LootingBag;
import io.shadowrealm.content.minigames.bounty_hunter.BountyHunter;
import io.shadowrealm.content.minigames.fight_cave.FightCave;
import io.shadowrealm.content.minigames.inferno.Inferno;
import io.shadowrealm.content.minigames.pest_control.PestControl;
import io.shadowrealm.content.minigames.pest_control.PestControlRewards;
import io.shadowrealm.content.minigames.pk_arena.Highpkarena;
import io.shadowrealm.content.minigames.pk_arena.Lowpkarena;
import io.shadowrealm.content.minigames.raids.RaidConstants;
import io.shadowrealm.content.minigames.raids.Raids;
import io.shadowrealm.content.minigames.tob.TobConstants;
import io.shadowrealm.content.minigames.tob.TobContainer;
import io.shadowrealm.content.minigames.tob.instance.TobInstance;
import io.shadowrealm.content.minigames.warriors_guild.WarriorsGuild;
import io.shadowrealm.content.minigames.xeric.XericLobby;
import io.shadowrealm.content.miniquests.MageArena;
...
import io.shadowrealm.content.preset.Preset;
import io.shadowrealm.content.prestige.PrestigeSkills;
import io.shadowrealm.content.privatemessaging.FriendsList;
import io.shadowrealm.content.questing.Questing;
import io.shadowrealm.content.skills.Agility;
import io.shadowrealm.content.skills.ExpLock;
import io.shadowrealm.content.skills.Skill;
import io.shadowrealm.content.skills.SkillInterfaces;
import io.shadowrealm.content.skills.agility.AgilityHandler;
import io.shadowrealm.content.skills.agility.impl.*;
import io.shadowrealm.content.skills.agility.impl.rooftop.*;
...
import io.shadowrealm.content.skills.mining.Mining;
import io.shadowrealm.content.skills.prayer.Prayer;
import io.shadowrealm.content.skills.runecrafting.RealRunecrafting;
import io.shadowrealm.content.skills.slayer.Slayer;
import io.shadowrealm.content.skills.smithing.Smelting;
import io.shadowrealm.content.skills.smithing.Smithing;
import io.shadowrealm.content.skills.smithing.SmithingInterface;
import io.shadowrealm.content.skills.thieving.Thieving;
import io.shadowrealm.content.teleportation.TeleportInterface2;
...
import io.shadowrealm.content.upgrading.ItemUpgrading;
import io.shadowrealm.content.vote_panel.VotePanelManager;
import io.shadowrealm.content.vote_panel.VoteUser;
import io.shadowrealm.content.wogw.WogwContributeInterface;
...
import io.shadowrealm.model.controller.Controller;
import io.shadowrealm.model.controller.ControllerRepository;
import io.shadowrealm.model.cycleevent.CycleEventHandler;
import io.shadowrealm.model.cycleevent.Event;
import io.shadowrealm.model.cycleevent.impl.MinigamePlayersEvent;
import io.shadowrealm.model.cycleevent.impl.RunEnergyEvent;
import io.shadowrealm.model.cycleevent.impl.SkillRestorationEvent;
...
import io.shadowrealm.model.entity.player.lock.PlayerLock;
import io.shadowrealm.model.entity.player.lock.Unlocked;
import io.shadowrealm.model.entity.player.migration.PlayerMigrationRepository;
import io.shadowrealm.model.entity.player.mode.Mode;
import io.shadowrealm.model.entity.player.mode.ModeRevertType;
import io.shadowrealm.model.entity.player.mode.ModeType;
import io.shadowrealm.model.entity.player.mode.RegularMode;
...
import io.shadowrealm.model.entity.player.packets.ChangeAppearance;
...
import io.shadowrealm.model.items.bank.Bank;
...
import io.shadowrealm.model.multiplayersession.duel.Duel;
import io.shadowrealm.model.multiplayersession.duel.DuelSession;
import io.shadowrealm.model.multiplayersession.flowerpoker.FlowerPoker;
import io.shadowrealm.model.multiplayersession.flowerpoker.FlowerPokerHand;
import io.shadowrealm.model.multiplayersession.trade.Trade;
import io.shadowrealm.model.shops.ShopAssistant;
import io.shadowrealm.model.tickable.Tickable;
import io.shadowrealm.model.tickable.TickableContainer;
import io.shadowrealm.model.timers.TickTimer;
import io.shadowrealm.model.world.Clan;
import io.shadowrealm.net.Packet;
import io.shadowrealm.net.PacketBuilder;
import io.shadowrealm.net.login.LoginReturnCode;
import io.shadowrealm.net.login.RS2LoginProtocol;
import io.shadowrealm.net.outgoing.UnnecessaryPacketDropper;
import io.shadowrealm.util.*;
import io.shadowrealm.util.discord.Discord;
import io.shadowrealm.util.logging.player.ChangeAddressLog;
import io.shadowrealm.util.logging.player.ConnectionLog;
...
public class Player extends Entity {
    ...
    public boolean alreadyFishing = false;
    ...
    public io.shadowrealm.content.preset.Set lastPreset;
    ...
    private io.shadowrealm.content.dwarfleaguecannon.Cannon dwarfCannon;
...
//    }
    ...
    public void destruct() {
        ...
        if (Discord.jda != null) {
            Discord.getJDA().getPresence().setPresence(OnlineStatus.ONLINE, Activity.playing("Shadow Realm with "+ ((int) (PlayerHandler.getPlayerCount() * 1)) + " players!"));
        }
    ...
    public void finishLogin() {
        ...
        if (getRights().getPrimary().equals(Right.HELPER)) {
            PlayerHandler.executeGlobalMessage("[@red@<shad=0>Helper</shad>@bla@] <col=255>" + getDisplayNameFormatted() + "@bla@ has just logged in!");
...
//        LeaderboardUtils.checkRewards(this);
    ...
    public int[] SLAYER_HELMETS = {11864, 11865, 19639, 19641, 19643, 19645, 19647, 19649, 21888, 21890, 21264, 21266, 23075, 24444, 24370, 25910, 29235};
...
public MoneyBox getMoneyBoxInterface() {
    ...
    public io.shadowrealm.content.dwarfleaguecannon.Cannon getLeagueCannon() {
        return dwarfCannon;
    }
    public void setLeagueCannon(io.shadowrealm.content.dwarfleaguecannon.Cannon dwarfCannon) {
