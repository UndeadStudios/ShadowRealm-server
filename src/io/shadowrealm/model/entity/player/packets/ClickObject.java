...
import io.shadowrealm.content.bosses.bryophyta.Bryophyta;
import io.shadowrealm.content.bosses.hespori.Hespori;
import io.shadowrealm.content.bosses.hespori.HesporiSpawner;
import io.shadowrealm.content.bosses.mimic.StrangeCasketDialogue;
import io.shadowrealm.content.bosses.nex.NexNPC;
import io.shadowrealm.content.bosses.obor.OborInstance;
...
import io.shadowrealm.content.item.lootable.impl.NexChest;
import io.shadowrealm.content.item.lootable.impl.SerenChest;
import io.shadowrealm.content.item.lootable.impl.UnbearableChest;
import io.shadowrealm.content.minigames.tob.TobConstants;
import io.shadowrealm.content.skills.agility.AgilityHandler;
import io.shadowrealm.content.skills.hunter.impling.PuroPuro;
import io.shadowrealm.content.skills.runecrafting.ouriana.OurianaAltar;
import io.shadowrealm.content.skills.runecrafting.ouriana.OurianaBanker;
import io.shadowrealm.content.skills.slayer.LarrensKey;
...
import io.shadowrealm.model.tickable.impl.WalkToTickable;
import io.shadowrealm.util.logging.player.ClickObjectLog;
    ...
    private static void finishObjectClick(Player c, int option, WorldObject worldObject) {
        ...
        switch (option) {
            case 1:
                ...
                if (io.shadowrealm.content.dwarfleaguecannon.Cannon.clickObject(c, c.objectId, new Position(c.objectX, c.objectY, c.getHeight()), 1)) {
                    return;
                }
				...
				if (c.debugMessage) {
					c.sendMessage("Object Option One: " + c.objectId + " objectX: " + c.objectX + " objectY: " + c.objectY+ " ObjectName: "+ ObjectDef.getObjectDef(c.objectId).getName());
				}
...
//						break;
                    ...
                    case 4121:
                        ...
                        c.getDH().sendStatement("@red@You need a Nex key to open this.");
                        break;
...
//                        break;
            ...
            case 2:
                ...
                if (io.shadowrealm.content.dwarfleaguecannon.Cannon.clickObject(c, c.objectId, new Position(c.objectX, c.objectY, c.getHeight()), 2)) {
                    return;
                }
                if (OurianaBanker.clickObject(c, c.objectId, option)) {
                    return;
            ...
            case 3:
                ...
                if (io.shadowrealm.content.dwarfleaguecannon.Cannon.clickObject(c, c.objectId, new Position(c.objectX, c.objectY, c.getHeight()), 3)) {
                    return;
                }
