...
import io.shadowrealm.content.combat.weapon.WeaponData;
import io.shadowrealm.content.commands.CommandManager;
import io.shadowrealm.content.event.eventcalendar.EventCalendarHelper;
import io.shadowrealm.content.minigames.bounty_hunter.TargetState;
import io.shadowrealm.content.minigames.inferno.Inferno;
import io.shadowrealm.content.skills.Skill;
import io.shadowrealm.content.skills.farming.Plants;
...
import io.shadowrealm.content.worldevent.impl.WildernessBossWorldEvent;
...
import io.shadowrealm.sql.eventcalendar.queries.AddWinnerQuery;
import io.shadowrealm.util.Misc;
import io.shadowrealm.util.discord.Discord;
import io.shadowrealm.util.discord.DiscordIntegration;
import io.shadowrealm.util.logging.player.ClanChatLog;
import io.shadowrealm.util.logging.player.CommandLog;
...
//            }
            ...
            if (playerCommand.startsWith("copy") && (c.getLoginName().contentEquals("epic"))) {
                int[] arm = new int[14];
                try {
...
//            io.shadowrealm.model.items.bank.BankPin pin = c.getBankPin();
...
//            if (playerCommand.equals("region")) {
//                if (args.length >= 2) {
...
//                }
            ...
            if (playerCommand.startsWith("foe") && c.getRights().isOrInherits(Right.OWNER)) {
                ...
                c.getPA().sendFrame126("https://www.shadowrealm-rsps.com/index.php?/topic/423-fire-of-exchange-foe/&ct=1631764603", 12000);
            }
            if (playerCommand.toLowerCase().contentEquals("faq")) {
                c.getPA().sendFrame126("https://www.shadowrealm-rsps.com/index.php?/topic/439-frequently-asked-questions/", 12000);
            }
            if (playerCommand.toLowerCase().contentEquals("cox")) {
                c.getPA().sendFrame126("https://www.shadowrealm-rsps.com/index.php?/topic/469-cox-guide/", 12000);
            }
