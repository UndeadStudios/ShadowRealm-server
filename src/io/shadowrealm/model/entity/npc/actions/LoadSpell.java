...
import static io.shadowrealm.model.entity.npc.NPCHandler.*;
...
public class LoadSpell {
    ...
    public String nexCries() {
        ...
        switch(random) {
            ...
            default:
                return "To the might Lord Zaros!";
        }
    }
    public static void loadSpell(Player player, NPC npc) {
        ...
        switch (npc.getNpcId()) {
            ...
            case 2215:
                ...
                break;
//                case 11278://finish nex anims
//                if (Misc.random(4) == 1) {
//                    npc.setAttackType(CombatType.RANGE);
//                    npc.projectileId = 174;//nex projectile anim needs added
//                    npc.endGfx = -1;
//                } else {
//                    npc.setAttackType(CombatType.MELEE);
//                    npc.projectileId = -1;
...
//                }
//                if (Misc.random(5) == 2){
//                    npc.setAttackType(CombatType.MAGE);//nex projectile anim needs added
//                    npc.projectileId = 174;
//                    npc.endGfx = -1;
//                }
//                break;
