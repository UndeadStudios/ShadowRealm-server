...
public abstract class TBDRoom {

    public abstract TBDBoss spawn(InstancedArea instancedArea);
    ...
    public GlobalObject getFoodChest(Position position, int face) {
        return new GlobalObject(TBDConstants.FOOD_CHEST_OBJECT_ID, position, face, 10);
    }
}
