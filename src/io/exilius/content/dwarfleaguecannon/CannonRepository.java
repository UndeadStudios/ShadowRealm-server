...
public class CannonRepository {
    private static final Logger logger = LoggerFactory.getLogger(io.exilius.content.dwarfleaguecannon.Cannon.class);
    private static final Map<Position, io.exilius.content.dwarfleaguecannon.Cannon> CANNON_MAP = new HashMap<>();

    public static boolean add(io.exilius.content.dwarfleaguecannon.Cannon cannon) {
