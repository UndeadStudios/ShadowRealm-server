...
public enum CollectionRewards {
    ...
    VETRION(6611, new GameItem[]{new GameItem(6199,1),
            new GameItem(995,100_000)}),

    CALLISTO(6609, new GameItem[]{new GameItem(6199,1),
            new GameItem(995,100_000)}),

    SCORPIA(6615, new GameItem[]{new GameItem(6199,1),
            new GameItem(995,100_000)}),

    VENENATIS(6610, new GameItem[]{new GameItem(6199,1),
            new GameItem(995,100_000)}),
    ELEMENTAL(2054, new GameItem[]{new GameItem(6199,1),
            new GameItem(995,100_000)}),
    FANATIC(6619, new GameItem[]{new GameItem(6199,1),
            new GameItem(995,100_000)}),
    ARCHAEOLOGIST(6618, new GameItem[]{new GameItem(6199,1),
            new GameItem(995,100_000)}),

    OLM(7554, new GameItem[]{new GameItem(6199,3),
            new GameItem(995,100_000)}),

    TOB(8360, new GameItem[]{new GameItem(6199,3),
            new GameItem(995,100_000)}),
