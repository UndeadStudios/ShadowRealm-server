...
public enum CollectionRewards {
    ...
    VETRION(6611, new GameItem[]{new GameItem(28827,1),
            new GameItem(6828,1)}),

    CALLISTO(6609, new GameItem[]{new GameItem(28827,1),
            new GameItem(6828,1)}),

    SCORPIA(6615, new GameItem[]{new GameItem(28827,1),
            new GameItem(6828,1)}),

    VENENATIS(6610, new GameItem[]{new GameItem(28827,1),
            new GameItem(6828,1)}),
    ELEMENTAL(2054, new GameItem[]{new GameItem(28827,1),
            new GameItem(6828,1)}),
    FANATIC(6619, new GameItem[]{new GameItem(28827,1),
            new GameItem(6828,1)}),
    ARCHAEOLOGIST(6618, new GameItem[]{new GameItem(28827,1),
            new GameItem(6828,1)}),

    OLM(7554, new GameItem[]{new GameItem(6830,1),
            new GameItem(995,200_000_000)}),

    TOB(8360, new GameItem[]{new GameItem(10025,1),
    ...
    EASY(1, new GameItem[]{new GameItem(6199,3),
            new GameItem(995,100_000)}),

    MEDIUM(2, new GameItem[]{new GameItem(6199,2),
            new GameItem(995,200_000)}),

    HARD(3, new GameItem[]{new GameItem(6199,2),
            new GameItem(995,200_000)}),
    MASTER(4, new GameItem[]{new GameItem(6199,3),}),
