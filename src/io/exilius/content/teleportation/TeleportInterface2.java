...
public class TeleportInterface2 {
    ...
    public enum TeleportationData {
        ...
        Brimhaven_Dungeon(5, 102219, true, "Teleports you to the Brimhaven Dungeon.", new Position(2709, 9476, 0)),
        Catacombs_of_Kourend(5, 102224, true, "Teleports you to the Catacombs.", new Position(1664, 10050,0)),
        Edgeville_dungeon(5, 102229, true, "Teleports you to the Edgeville Dungeon.", new Position(3097, 9868, 0)),
        Forthos_Dungeon(5, 102234, true, "Teleports you to the Forthos Dungeon.", new Position(1800, 9968,0)),
        Fremennik_Slayer_Dungeon(5, 102239, true, "Teleports you to the Fremennik Slayer Dungeon.", new Position(2807, 10002, 0)),
        Taverly_Dungeon(5, 102244, true, "Teleports you to the Taverly Dungeon.", new Position(2883, 9800, 0)),
        Stronghold_Slayer_Cave(5, 102249, true, "Teleports you to the Stronghold Slayer Cave.", new Position(2452, 9820, 0)),
