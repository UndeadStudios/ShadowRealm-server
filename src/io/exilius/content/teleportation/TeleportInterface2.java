...
public class TeleportInterface2 {
    ...
    public enum TeleportationData {
        ...
        Ganbling_Zone(1, 102224, true, "Ganbling Zone", new Position(2129, 9489, 0)),
        Skilling_Island(1, 102229, true, "Skilling Island", new Position(3803, 3538, 0)),
        ...
        Wildy_event(7, 103008, false, "Wildy event", new Position(MonsterHunt.getCurrentLocation().getX(), MonsterHunt.getCurrentLocation().getY(), 0)),
        King_black_dragon(7, 103013, false, "King Black Dragon @red@(42 Wild)", new Position(3005, 3849, 0)),
        Vetion(7, 103018, false, "Vet'ion @red@(40 Wild)", new Position(3200, 3794, 0)),
        Scorpia(7, 103023, false, "Scorpia @red@(54 Wild)", new Position(3233, 3945, 0)),
        Venenatis(7, 103028, false, "Venenatis @red@(28 Wild)", new Position(3345, 3754, 0)),
        Chaos_Elemental(7, 103033, false, "Chaos Elemental @red@(50 Wild)", new Position(3285, 3925, 0)),
        Chaos_Fanatic(7, 103038, false, "Chaos Fanatic @red@(41 Wild)", new Position(2978, 3833, 0)),
        Chaos_Archaeologist(7, 103043, false, "Crazy Archaeologist @red@(23 Wild)", new Position(2984, 3713, 0)),
