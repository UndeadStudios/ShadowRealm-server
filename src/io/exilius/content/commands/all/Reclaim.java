...
import io.exilius.sql.donation.reclaim.ReclaimDonationResponse;
import io.exilius.sql.donation.reclaim.ReclaimQuery;
import io.exilius.util.Misc;
import io.exilius.util.logging.player.ReclaimDonationLog;
...
public class Reclaim extends Command {
	...
	public Optional<String> getDescription() {
		return Optional.of("Reclaim donations from exilius v1 between ");
	}
}
