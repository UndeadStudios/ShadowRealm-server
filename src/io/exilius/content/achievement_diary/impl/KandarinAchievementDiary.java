...
public final class KandarinAchievementDiary extends StatefulAchievementDiary<KandarinDiaryEntry> {
	...
	public final void display() {
		...
		int[] frames = { 26485, 26486, 26487, 26488, 26490, 26491, 26492, 26493, 26494, 26496, 26497, 26498, 26499, 26501, 26502,
		...
		player.getPA().sendFrame126("@dre@Kandarin Diary", 26659);
