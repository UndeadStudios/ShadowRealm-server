...
import io.exilius.content.boosts.other.GenericBoost;
import io.exilius.content.boosts.xp.ExperienceBooster;
...
public class Boosts {
    ...
    public static void init() {
        ...
        Reflections reflections = new Reflections("io.exilius.content.boosts", new SubTypesScanner());
