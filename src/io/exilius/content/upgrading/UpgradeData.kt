...
enum class UpgradeData(
    ...
    LTORVA_PLATELEGS(Categories.ARMOUR, 8812, GameItem(8469, 1), 350_000_000, 30.0),
    LTORVA_PLATEBODY(Categories.ARMOUR, 8813, GameItem(8467, 1), 350_000_000, 30.0),
    LTORVA_FULL_HELM(Categories.ARMOUR, 8814, GameItem(8465, 1), 350_000_000, 30.0),
    Godly_Cape(Categories.ARMOUR, 28347, GameItem(19480, 1), 350_000_000, 30.0),
    ...
    CRYSTAL_KEY(Categories.OTHER,989, GameItem(11942,1),100_000_000,1.0),//into ecumenical key
