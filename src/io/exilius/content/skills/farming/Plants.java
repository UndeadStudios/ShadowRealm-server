...
public enum Plants {
	REDBERRY_BUSH(Items.REDBERRY_SEED, Items.REDBERRIES, 0x05, 5 + 13, 5 + 19, 8 + 25, 5 + 26, 10, 80, SeedType.BUSH, 11.5, 64, 93.5, 6),
	...
	JANGERBERRY_BUSH(Items.JANGERBERRY_SEED, Items.JANGERBERRIES, 38,  38 + 13, 38 + 19, 38 + 25, 38 + 26, 48, 80, SeedType.BUSH, 50.5, 284.5, 19, 9),
	WHITEBERRY_BUSH(Items.WHITEBERRY_SEED, Items.WHITE_BERRIES, 51,  51 + 13, 51 + 19, 51 + 25, 51 + 26, 59, 80, SeedType.BUSH, 78, 437, 29, 9),
	POISON_INV_VERRY_BUSH(Items.POISON_IVY_SEED, Items.POISON_IVY_BERRIES, 197,  197 + 13, 197 + 19, 197 + 25, 197 + 26, 70, 80, SeedType.BUSH, 120, 675, 45, 9),
	...
	APPLE_TREE(Items.APPLE_SAPLING, Items.COOKING_APPLE, 8, 8 + 12, 8 + 18, 0x22, 0x22, 27, 80, SeedType.FRUIT_TREE, 22.0, 1199.0, 8.5, 7),
	...
	CURRY_TREE(Items.CURRY_SAPLING, Items.CURRY_LEAF, 99, 99 + 13, 99 + 19, 99 + 25, 99 + 26, 42, 80, SeedType.FRUIT_TREE, 40, 2906.9, 15, 7),
	PINEAPPLE_TREE(Items.PINEAPPLE_SAPLING, Items.PINEAPPLE, 136, 136 + 13, 136 + 19, 136 + 25, 136 + 26, 51, 80, SeedType.FRUIT_TREE, 57, 4605, 21.5, 7),
