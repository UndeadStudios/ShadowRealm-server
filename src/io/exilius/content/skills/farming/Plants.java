...
public enum Plants {
	...
	DWELLBERRY_BUSH(Items.DWELLBERRY_SEED, Items.DWELLBERRIES, 26,  26 + 13, 26 + 19, 26 + 25, 26 + 26, 36, 80, SeedType.BUSH, 31.5, 177.5, 12, 7),
	JANGERBERRY_BUSH(Items.JANGERBERRY_SEED, Items.JANGERBERRIES, 38,  38 + 13, 38 + 19, 38 + 25, 38 + 26, 48, 80, SeedType.BUSH, 50.5, 284.5, 19, 8),
	WHITEBERRY_BUSH(Items.WHITEBERRY_SEED, Items.WHITEBERRY_SEED, 51,  51 + 13, 51 + 19, 51 + 25, 51 + 26, 59, 80, SeedType.BUSH, 78, 437, 29, 8),
	POISON_INV_VERRY_BUSH(Items.POISON_IVY_SEED, Items.POISON_IVY_BERRIES, 197,  197 + 13, 197 + 19, 197 + 25, 197 + 26, 70, 80, SeedType.BUSH, 120, 675, 45, 8),
	...
	ORANGE_TREE(Items.ORANGE_SAPLING, Items.ORANGE, 72, 72 + 13, 72 + 19, 72 + 25, 72 + 26, 39, 80, SeedType.FRUIT_TREE, 35.0, 2470.2, 13.5, 7),
	CURRY_TREE(Items.CURRY_SAPLING, Items.CURRY_LEAF, 99, 99 + 13, 99 + 19, 99 + 25, 99 + 26, 42, 80, SeedType.FRUIT_TREE, 40, 2906.9, 15, 6),
	PINEAPPLE_TREE(Items.PINEAPPLE_SAPLING, Items.PINEAPPLE, 136, 136 + 13, 136 + 19, 136 + 25, 136 + 26, 51, 80, SeedType.FRUIT_TREE, 57, 4605, 21.5, 6),
	PAPAYA_TREE(Items.PAPAYA_SAPLING, Items.PAPAYA_FRUIT, 163, 163 + 13, 163 + 19, 163 + 25, 163 + 26, 57, 80, SeedType.FRUIT_TREE, 72, 6146.6, 27, 6),
	PALM_TREE(Items.PALM_SAPLING, Items.COCONUT, 200, 200 + 13, 200 + 19, 200 + 25, 200 + 26, 68, 80, SeedType.FRUIT_TREE, 110.5, 10150.1, 41.5, 6),
