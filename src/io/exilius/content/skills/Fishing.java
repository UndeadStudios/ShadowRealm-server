...
public class Fishing extends SkillHandler {
	...
	public static int[][] data = { 
			{ 1, 1, 303, -1, 317, 10, 621, 321, 15, 30, 12000 }, // SHRIMP 1
			{ 2, 5, 307, 313, 327, 20, 622, 345, 10, 30, 12000 }, // SARDINE + HERRING 2
			{ 3, 16, 305, -1, 353, 20, 620, -1, -1, -1, 12000 }, // MACKEREL 3
			{ 4, 20, 309, 314, 335, 50, 622, 331, 30, 70, 12000 }, // TROUT 4
			{ 5, 23, 305, -1, 341, 45, 619, 363, 46, 100, 12000 }, // BASS + COD 5
			{ 6, 25, 309, 314, 349, 60, 622, -1, -1, -1, 12000 }, // PIKE 6
			{ 7, 35, 311, -1, 359, 80, 618, 371, 50, 100, 12000 }, // TUNA + SWORDIE 7
			{ 7, 35, 21028, -1, 359, 80, 7401, 371, 50, 100, 12000 }, // TUNA + SWORDIE 8
			{ 7, 35, 21031, -1, 359, 80, 7402, 371, 50, 100, 12000 }, // TUNA + SWORDIE 9
			{ 8, 40, 301, -1, 377, 90, 619, -1, -1, -1, 10000 }, // LOBSTER 9
			...
			{ 11, 79, 305, -1, 395, 120, 620, 389, 81, 130, 6000 }, // SEA TURTLE
			{ 12, 81, 305, -1, 389, 140, 620, -1, -1, -1, 6000 }, // MANTA RAY
			{ 13, 85, 301, 11940, 11934, 150, 619, -1, -1, -1, 6000 }, // DARK CRAB
			{ 14, 1, -1, -1, 3150, 1, 620, -1, -1, -1, 15000 }, // Karambwanji AFK FISH
			{ 15, 65, 3159, 3150, 3142, 105, 620, -1, -1, -1, 8000 }, // Karambwan
			{ 16, 82, 307, 13431, 13439, 188, 622, -1, -1, -1, 6000 } // Anglerfish
	};
