...
public class Objects {
	...
	enum CON_DATA {
		Crude_wooden_chair(4515, 6752, 1, 58, 1539, 2, 960, 2, "Crude wooden chair", 898),
		wooden_chair(4515, 6753, 8, 87, 1539, 3, 960, 3, "Wooden chair", 898),
		rocking_chair(4515, 6754, 14, 87, 1539, 3, 960, 3, "Rocking chair", 898),
		oak_chair(4515, 6755, 19, 120, 8778, 2, "Oak chair", 898),
		oak_armchair(4515, 6756, 26, 180, 8778, 3, "Oak armchair", 898),
		teak_armchair(4515, 6757, 35, 180, 8780, 2, "Teak armchair", 898),
		mahogany_armchair(4515, 6758, 50, 280, 8782, 2, "Mahogany armchair", 898),

		Crude_wooden_chair2(4516, 6752, 1, 58, 1539, 2, 960, 2, "Crude wooden chair", 898),
		wooden_chair2(4516, 6753, 8, 87, 1539, 3, 960, 3, "Wooden chair", 898),
		rocking_chair2(4516, 6754, 14, 87, 1539, 3, 960, 3, "Rocking chair", 898),
		oak_chair2(4516, 6755, 19, 120, 8778, 2, "Oak chair", 898),
		oak_armchair2(4516, 6756, 26, 180, 8778, 3, "Oak armchair", 898),
		teak_armchair2(4516, 6757, 35, 180, 8780, 2, "Teak armchair", 898),
		mahogany_armchair2(4516, 6758, 50, 280, 8782, 2, "Mahogany armchair", 898),

		Crude_wooden_chair3(4517, 6752, 1, 58, 1539, 2, 960, 2, "Crude wooden chair", 898),
		wooden_chair3(4517, 6753, 8, 87, 1539, 3, 960, 3, "Wooden chair", 898),
		rocking_chair3(4517, 6754, 14, 87, 1539, 3, 960, 3, "Rocking chair", 898),
		oak_chair3(4517, 6755, 19, 120, 8778, 2, "Oak chair", 898),
		oak_armchair3(4517, 6756, 26, 180, 8778, 3, "Oak armchair", 898),
		teak_armchair3(4517, 6757, 35, 180, 8780, 2, "Teak armchair", 898),
		mahogany_armchair3(4517, 6758, 50, 280, 8782, 2, "Mahogany armchair", 898),

		WOODEN_BOOKCASE(4521, 6768, 4, 115, 1539, 4, 960, 4, "Wooden bookcase", 898),
		OAK_BOOKCASE(4521, 6769, 29, 180, 8778, 3, "Oak bookcase", 898),
		MAHOGANY_BOOKCASE(4521, 6770, 40, 420, 8782, 3, "Mahogany bookcase", 898),
		...
		CON_DATA(int fake_object, int real_object, int Level, int xp, int item1, int amount1, String objectName, int animation){
		...
		CON_DATA(int fake_object, int real_object, int Level, int xp, int item1, int amount1, int item2, int amount2, String objectName, int animation){
			this.fake_object = fake_object;
			this.real_object = real_object;
			this.Level = Level;
			this.xp = xp;
		...
		CON_DATA(int fake_object, int real_object, int Level, int xp, int item1, int amount1, int item2, int amount2, int item3, int amount3, int item4, int amount4, String objectName, int animation){
			this.fake_object = fake_object;
			this.real_object = real_object;
			this.Level = Level;
			this.xp = xp;
		...
		CON_DATA(int fake_object, int real_object, int Level, int xp, int item1, int amount1, int item2, int amount2, int item3, int amount3, int item4, int amount4, int item5, int amount5, String objectName, int animation){
			this.fake_object = fake_object;
			this.real_object = real_object;
			this.Level = Level;
			this.xp = xp;
