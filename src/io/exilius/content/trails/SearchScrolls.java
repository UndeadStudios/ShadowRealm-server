...
public class SearchScrolls {
    ...
    public static enum SearchData {
        ...
        CRATE23(new String[]{"A town with a different sort of", "night-life is your destination. ", "Search for some crates in one", "of the houses."}, Items.CLUE_SCROLL_EASY_29, new Position(3498, 3507, 0), -1, 832, 2),

        BOXES1(new String[]{"Search the boxes in one of ", "the tents in Al Kharid"}, Items.CLUE_SCROLL_EASY_30, new Position(3308, 3206, 0), -1, 832, 1),
        BOXES2(new String[]{"Search the boxes in the ", "Goblin house near Lumbridge"}, Items.CLUE_SCROLL_EASY_31, new Position(3245, 3245, 0), -1, 832, 1),
        BOXES3(new String[]{"Search the boxes in the ", "house near the South ", "entrance of Varrock"}, Items.CLUE_SCROLL_EASY_32, new Position(3203, 3384, 0), -1, 832, 1),
        BOXES4(new String[]{"Search the boxes near a cart ", "in Varrock"}, Items.CLUE_SCROLL_EASY_33, new Position(3228, 3454, 0), -1, 832, 1),
        BOXES6(new String[]{"Search the boxes of", "Falador's general store"}, Items.CLUE_SCROLL_EASY_34, new Position(2955, 3390, 0), -1, 832, 1),
        BOXES7(new String[]{"Search the tents in the ", "imperial guard camp in", "Burthorpe for some boxes"}, Items.CLUE_SCROLL_EASY_35, new Position(2885, 3540, 0), -1, 832, 1),
        BOXES8(new String[]{"Search the boxes in a shop ", "in Taverley"}, Items.CLUE_SCROLL_EASY_36, new Position(2886, 3449, 0), -1, 832, 1),

        CHEST1(new String[]{"Search the chest in the Duke ", "of Lumbridge's bedroom"}, Items.CLUE_SCROLL_EASY_37, new Position(3209, 3218, 1), 378, 832, 1),
        CHEST2(new String[]{"Search the chest in the left-", "hand tower of Camelot castle"}, Items.CLUE_SCROLL_EASY_38, new Position(2748, 3495, 2), 378, 832, 1),
        CHEST3(new String[]{"Search the chests in the", "Dwarven Mine"}, Items.CLUE_SCROLL_EASY_39, new Position(3000, 9798, 0), 378, 832, 1),
        CHEST4(new String[]{"Search the chests upstairs in", "Al Kharid palace."}, Items.CLUE_SCROLL_EASY_40, new Position(3301, 3169, 1), 378, 832, 1),
        CHEST5(new String[]{"Search chests found in the", "upstairs of shops in Port", "Sarim"}, Items.CLUE_SCROLL_EASY_41, new Position(3016, 3205, 1), 378, 832, 1),
        CHEST6(new String[]{"Search through chests found ", "in the upstairs of houses in ", "eastern Falador."}, Items.CLUE_SCROLL_EASY_42, new Position(3041, 3364, 1), 378, 832, 1),

        DRAWERS1(new String[]{"Search the drawers above", "Varrock's shops."}, Items.CLUE_SCROLL_EASY_43, new Position(3206, 3419, 1), 351, 832, 1),
        DRAWERS3(new String[]{"Search the drawers in a ", "house in Draynor Village."}, Items.CLUE_SCROLL_EASY_44, new Position(3097, 3277, 0), 351, 832, 1),
        DRAWERS4(new String[]{"Search the drawers in", "Falador's chainmail shop"}, Items.CLUE_SCROLL_EASY_45, new Position(2969, 3311, 0), 349, 832, 1),
        DRAWERS5(new String[]{"Search the drawers in one of", "Gertrude's bedrooms"}, Items.CLUE_SCROLL_EASY_46, new Position(3156, 3406, 0), 349, 832, 1),
        DRAWERS7(new String[]{"Search the drawers in the ", "upstairs of a house in ", "Catherby."}, Items.CLUE_SCROLL_EASY_47, new Position(2809, 3451, 1), 351, 832, 1),
        DRAWERS8(new String[]{"Search the drawers in the ", "upstairs of the bank to the ", "east of Varrock"}, Items.CLUE_SCROLL_EASY_48, new Position(3250, 3420, 1), 349, 832, 1),
        DRAWERS9(new String[]{"Search the drawers of houses ", "in Burthorpe"}, Items.CLUE_SCROLL_EASY_49, new Position(2929, 3570, 0), 349, 832, 1),
        DRAWERS10(new String[]{"Search the drawers on the ", "first floor of a building ", "overlooking Ardougne's ", "market"}, Items.CLUE_SCROLL_EASY_50, new Position(2657, 3322, 1), 353, 832, 1),
        DRAWERS11(new String[]{"Search the drawers upstairs ", "in Falador's shield shop."}, Items.CLUE_SCROLL_EASY_51, new Position(2971, 3386, 1), 349, 832, 1),
        DRAWERS12(new String[]{"Search through some drawers ", "found in Taverley's houses."}, Items.CLUE_SCROLL_EASY_52, new Position(2894, 3418, 0), 351, 832, 1),
        DRAWERS13(new String[]{"Search through some drawers ", "in the upstairs of a house in ", "Rimmington."}, Items.CLUE_SCROLL_EASY_53, new Position(2970, 3214, 1), 353, 832, 1),
        ...
        DRAWERS15(new String[]{"Search upstairs in the ", "houses of Seers' Village for ", "some drawers."}, Items.CLUE_SCROLL_EASY_54, new Position(2716, 3471, 1), 348, 832, 1),
