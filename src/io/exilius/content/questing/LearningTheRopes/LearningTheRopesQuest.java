package io.exilius.content.questing.LearningTheRopes;
...
import io.exilius.content.questing.Quest;
...
public class LearningTheRopesQuest extends Quest {
    ...
    public List<String> getJournalText(int stage) {
        ...
        switch (stage) {
            case 0:
                lines.add("To start this quest talk to the exilius Guide");
                                            ...
                                            player.start(getexiliusGuide()
                                                    ...
                                                    .option(new DialogueOption("Sure, I can start now!", e -> {
                                                                ...
                                                                e.start(getexiliusGuide()
                                                                        ...
                                                                        .npc("The information these display", "will help you during your time in exilius.")
