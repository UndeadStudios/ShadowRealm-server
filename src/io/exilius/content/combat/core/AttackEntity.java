...
import io.exilius.content.combat.range.Bow;
import io.exilius.content.combat.range.RangeData;
import io.exilius.content.combat.specials.Special;
import io.exilius.content.combat.specials.Specials;
import io.exilius.content.combat.weapon.AttackStyle;
import io.exilius.content.combat.weapon.RangedWeaponType;
...
import io.exilius.model.collisionmap.PathChecker;
...
//        }
    ...
    private boolean determineWeaponStyle() {
        ...
        if (!attacker.usingMagic) {
            ...
            attacker.usingCross =
                    attacker.playerEquipment[Player.playerWeapon] == 4734 || attacker.playerEquipment[Player.playerWeapon] == 9185 || attacker.playerEquipment[Player.playerWeapon] == 11785 || attacker.playerEquipment[Player.playerWeapon] == 21012 || attacker.playerEquipment[Player.playerWeapon] == 26374|| attacker.playerEquipment[Player.playerWeapon] == 21902;
            ...
            if (!Bow.canUseArrow(attacker) && Configuration.CORRECT_ARROWS && attacker.usingBow && !attacker.getCombatItems().usingCrystalBow() && !(attacker.playerEquipment[Player.playerWeapon] == 22550) && attacker.playerEquipment[Player.playerWeapon] != 9185
                    && attacker.playerEquipment[Player.playerWeapon] != 4734 && attacker.playerEquipment[Player.playerWeapon] != 26374 && attacker.playerEquipment[Player.playerWeapon] != 11785 && attacker.playerEquipment[Player.playerWeapon] != 21012 && attacker.playerEquipment[Player.playerWeapon] != 12926 && attacker.playerEquipment[Player.playerWeapon] != 19478 && attacker.playerEquipment[Player.playerWeapon] != 19481 && attacker.playerEquipment[Player.playerWeapon] != 21902) {
