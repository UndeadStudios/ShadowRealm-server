...
public class RSAKeyGen {
	...
	public static void main(String[] args) {
		try {
			...
			writeKey("C:\\Users\\Administrator\\Desktop\\server\\server\\Data\\rsapriv", privSpec.getModulus(), privSpec.getPrivateExponent());

			RSAPublicKeySpec pubSpec = factory.getKeySpec(publicKey, RSAPublicKeySpec.class);
			writeKey("C:\\Users\\Administrator\\Desktop\\server\\server\\Data\\rsapub", pubSpec.getModulus(), pubSpec.getPublicExponent());
		} catch(Exception e) {
			e.printStackTrace();
		}
	}
