...
import io.exilius.content.combat.weapon.WeaponMode;
...
//import io.exilius.content.donationrewards.DonationRewards;
import io.exilius.content.dwarfmulticannon.Cannon;
import io.exilius.content.event.eventcalendar.EventChallengeMonthlyReward;
...
import io.exilius.content.combat.EntityDamageQueue;
...
import io.exilius.content.miniquests.MageArena;
...
import io.exilius.model.controller.Controller;
import io.exilius.model.controller.ControllerRepository;
import io.exilius.model.entity.player.lock.PlayerLock;
import io.exilius.model.entity.player.lock.Unlocked;
import io.exilius.model.entity.player.migration.PlayerMigrationRepository;
import io.exilius.model.entity.player.mode.ModeRevertType;
...
import io.exilius.model.entity.player.packets.ChangeAppearance;
import io.exilius.model.entity.player.save.PlayerAddresses;
import io.exilius.model.items.*;
import io.exilius.model.StringInput;
import io.exilius.model.multiplayersession.flowerpoker.FlowerPoker;
import io.exilius.model.multiplayersession.flowerpoker.FlowerPokerHand;
import io.exilius.model.tickable.Tickable;
import io.exilius.model.tickable.TickableContainer;
...
import io.exilius.model.cycleevent.impl.MinigamePlayersEvent;
import io.exilius.model.cycleevent.impl.RunEnergyEvent;
import io.exilius.model.cycleevent.impl.SkillRestorationEvent;
import io.exilius.content.item.lootable.unref.CoinBagBuldging;
import io.exilius.content.achievement.AchievementHandler;
...
//import io.exilius.content.cheatprevention.RandomEventInterface;
...
import io.exilius.content.combat.melee.QuickPrayers;
import io.exilius.content.combat.stats.BossTimers;
import io.exilius.content.combat.stats.NPCDeathTracker;
...
import io.exilius.content.item.lootable.impl.VoteMysteryBox;
import io.exilius.content.item.lootable.impl.NormalMysteryBox;
import io.exilius.content.item.lootable.impl.PvmCasket;
import io.exilius.content.item.lootable.impl.SuperMysteryBox;
import io.exilius.content.item.lootable.impl.UltraMysteryBox;
import io.exilius.content.item.lootable.unref.CoinBagLarge;
import io.exilius.content.item.lootable.unref.CoinBagMedium;
import io.exilius.content.item.lootable.unref.CoinBagSmall;
import io.exilius.content.item.lootable.unref.DailyGearBox;
import io.exilius.content.item.lootable.unref.DailySkillBox;
import io.exilius.content.items.Degrade;
import io.exilius.content.items.pouch.GemBag;
import io.exilius.content.items.pouch.HerbSack;
...
import io.exilius.content.minigames.raids.RaidConstants;
import io.exilius.content.minigames.warriors_guild.WarriorsGuild;
import io.exilius.content.minigames.xeric.XericLobby;
import io.exilius.content.polls.PollTab;
import io.exilius.content.preset.Preset;
import io.exilius.content.prestige.PrestigeSkills;
import io.exilius.content.skills.Agility;
import io.exilius.content.skills.ExpLock;
import io.exilius.content.skills.SkillInterfaces;
import io.exilius.content.skills.agility.AgilityHandler;
import io.exilius.content.skills.agility.impl.BarbarianAgility;
import io.exilius.content.skills.agility.impl.GnomeAgility;
import io.exilius.content.skills.agility.impl.Lighthouse;
import io.exilius.content.skills.agility.impl.Shortcuts;
import io.exilius.content.skills.agility.impl.WildernessAgility;
import io.exilius.content.skills.agility.impl.rooftop.RooftopAlkharid;
import io.exilius.content.skills.agility.impl.rooftop.RooftopCanafis;
import io.exilius.content.skills.agility.impl.rooftop.RooftopDraynor;
import io.exilius.content.skills.agility.impl.rooftop.RooftopFalador;
import io.exilius.content.skills.agility.impl.rooftop.RooftopPollnivneach;
import io.exilius.content.skills.agility.impl.rooftop.RooftopRellekka;
...
import io.exilius.model.entity.player.mode.RegularMode;
import io.exilius.model.items.bank.Bank;
import io.exilius.model.items.bank.BankPin;
import io.exilius.model.lobby.LobbyManager;
import io.exilius.model.lobby.LobbyType;
...
import io.exilius.sql.etc.HiscoresUpdateQuery;
import io.exilius.sql.outlast.OutlastLeaderboardAdd;
...
public class Player extends Entity {
    ...
    public io.exilius.content.preset.Set lastPreset;
...
//    }
    ...
    public void destruct() {
        ...
        if (!getRights().isNotAdmin() && !getRights().contains(Right.OWNER)) {
            boolean debugMessage = true;
            //Right right = rank.rights;
            if (getMode().isRegular())
                com.everythingrs.hiscores.Hiscores.update("MLLnFosU8sgebEdogXuricTJPJnDPz6QSLjLZpMdnDjFlojMhTfWEfHmwTsesBF1yqFIvg1B", "Normal Mode", this.getDisplayName(), 0, this.playerXP, debugMessage);
            if (getMode().isIronman())
                com.everythingrs.hiscores.Hiscores.update("MLLnFosU8sgebEdogXuricTJPJnDPz6QSLjLZpMdnDjFlojMhTfWEfHmwTsesBF1yqFIvg1B", "Rogue Ironman Mode", this.getDisplayName(), 0, this.playerXP, debugMessage);
            if (getMode().isHardcoreIronman())
                com.everythingrs.hiscores.Hiscores.update("MLLnFosU8sgebEdogXuricTJPJnDPz6QSLjLZpMdnDjFlojMhTfWEfHmwTsesBF1yqFIvg1B", "Hardcore Ironman Mode", this.getDisplayName(), 0, this.playerXP, debugMessage);
            if (getMode().isGroupIronman())
                com.everythingrs.hiscores.Hiscores.update("MLLnFosU8sgebEdogXuricTJPJnDPz6QSLjLZpMdnDjFlojMhTfWEfHmwTsesBF1yqFIvg1B", "Group Ironman Mode", this.getDisplayName(), 0, this.playerXP, debugMessage);
            if (getMode().isrogue())
                com.everythingrs.hiscores.Hiscores.update("MLLnFosU8sgebEdogXuricTJPJnDPz6QSLjLZpMdnDjFlojMhTfWEfHmwTsesBF1yqFIvg1B", "Rogue Mode", this.getDisplayName(), 0, this.playerXP, debugMessage);
            if (getMode().isrogueiron())
                com.everythingrs.hiscores.Hiscores.update("MLLnFosU8sgebEdogXuricTJPJnDPz6QSLjLZpMdnDjFlojMhTfWEfHmwTsesBF1yqFIvg1B", "Ironman Mode", this.getDisplayName(), 0, this.playerXP, debugMessage);
            if (getMode().isroguehc())
                com.everythingrs.hiscores.Hiscores.update("MLLnFosU8sgebEdogXuricTJPJnDPz6QSLjLZpMdnDjFlojMhTfWEfHmwTsesBF1yqFIvg1B", "Rogue Hardcore Ironman Mode", this.getDisplayName(), 0, this.playerXP, debugMessage);
        }
    ...
    public void finishLogin() {
        ...
        if (getRights().getPrimary().equals(Right.HELPER)) {
            PlayerHandler.executeGlobalMessage("[@red@helper@bla@] <col=255>" + getDisplayNameFormatted() + "@bla@ has just logged in!");
        ...
        } else if (getLoginName().equals("sniper")) {
            PlayerHandler.executeGlobalMessage("[@red@Owner@bla@] <col=255>" + getDisplayNameFormatted() + "@bla@ has just logged in!");
