...
import io.exilius.content.combat.formula.rework.RangeCombatFormula;
import io.exilius.content.combat.melee.MeleeExtras;
import io.exilius.content.instances.InstancedArea;
import io.exilius.content.minigames.barrows.brothers.Brother;
import io.exilius.content.minigames.fight_cave.Wave;
import io.exilius.content.minigames.inferno.InfernoWaveData;
import io.exilius.content.minigames.pest_control.PestControl;
import io.exilius.content.minigames.xeric.XericWave;
import io.exilius.content.questing.hftd.DagannothMother;
...
public static void addNPC(int npcType, int x, int y, int h) {
    ...
    public static boolean isFightCaveNpc(NPC npc) {
        ...
        switch (npc.getNpcId()) {
        case io.exilius.content.minigames.fight_cave.Wave.TZ_KEK_SPAWN:
        case io.exilius.content.minigames.fight_cave.Wave.TZ_KIH:
        case io.exilius.content.minigames.fight_cave.Wave.TZ_KEK:
        case io.exilius.content.minigames.fight_cave.Wave.TOK_XIL:
        case io.exilius.content.minigames.fight_cave.Wave.YT_MEJKOT:
        case io.exilius.content.minigames.fight_cave.Wave.KET_ZEK:
        case Wave.TZTOK_JAD: 
            return true;
        }
        return false;
